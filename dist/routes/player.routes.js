...
router.post("/attendance", auth_middleware_1.protect, player_controller_1.markAttendance);
router.post("/multipleAttendance", auth_middleware_1.protect, player_controller_1.markMultipleAttendances);
router.get("/attendance", auth_middleware_1.protect, player_controller_1.getAttendanceByDate);
router.get("/getFullAttendance", auth_middleware_1.protect, player_controller_1.getFullAttendanceByDate);
